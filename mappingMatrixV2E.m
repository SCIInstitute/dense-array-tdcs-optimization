function [mapV2E, cellVolumeArray] = mappingMatrixV2E(headMesh)
%Finds the matrix that links the potential (at mesh nodes) to electric field at
% mesh cells. It also provides the volumes of mesh cells.
%
%
% Synopsis: [G,V] = mappingMatrixV2E(headMesh)
%
%
...
%
%
% Output:   mapV2E           = mapping matrix from potential to electric field
%           cellVolumeArray  = cell volumes
%
%
...
fprintf('Calculating the transfer matrix from potential to electrical field...\n');
...
fprintf('%s%f%s\n','The mapping matrix from potential to electric field is calculated in ',toc,' seconds.');
